...
function SocialMedia() {
  const services = [
    ...
    },
    {
      ...
      description:
        'Build and nurture an active community around your brand on social media.',
      image: socialEngagement,
    },
    {
      title: 'Social Advertising',
      description:
        'Targeted paid campaigns that reach your ideal audience and drive conversions.',
  ...
  const platforms = [
    {
      ...
      description: 'Engage with your audience on the largest social networks.',
      icon: '📱',
    },
    {
      title: 'LinkedIn',
      description:
        'Build your professional brand and connect with business decision-makers.',
      icon: '💼',
    },
    {
      title: 'Twitter',
      description: 'Join real-time conversations and build brand awareness.',
      icon: '🐦',
    },
    {
      title: 'TikTok',
      description:
        'Create viral content that resonates with younger audiences.',
      icon: '🎵',
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 bg-white">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="mb-4">Our Social Media Services</h2>
            <p className="text-xl text-gray-700">
              Comprehensive social media solutions to help your business grow.
            </p>
          </div>
          <motion.div
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="mb-4">Platforms We Cover</h2>
            <p className="text-xl text-gray-700">
              Strategic presence across all major social media platforms.
            </p>
          </div>
          <motion.div
          ...
          >
            {platforms.map((platform, index) => (
              <FeatureCard key={index} {...platform} />
            ))}
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-8 text-blue-50">
              Let's create a social media strategy that engages your audience
              and drives results.
            </p>
